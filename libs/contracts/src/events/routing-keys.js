...
exports.RedisChannels = exports.Commands = exports.DomainEvents = exports.AnalyticsEvents = exports.FileEvents = exports.VideoEvents = exports.ChatEvents = exports.TaskEvents = exports.ApprovalEvents = exports.HrEvents = exports.AuthEvents = void 0;
...
exports.RedisChannels = {
    ...
    boardPresence: (boardId) => `board:${boardId}:presence`,
    callSpeaking: (roomId) => `call:${roomId}:speaking`,
};
