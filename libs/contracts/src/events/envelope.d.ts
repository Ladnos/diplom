...
export type EnvelopeDraft<TPayload> = Pick<Envelope<TPayload>, 'eventType' | 'payload'> & Partial<Pick<Envelope<TPayload>, 'eventVersion' | 'causationId' | 'actor'>>;
...
export declare const CURRENT_EVENT_VERSION = 1;
