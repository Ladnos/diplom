...
export type EmploymentType = 'LABOR_CONTRACT' | 'CIVIL_CONTRACT' | 'SELF_EMPLOYED' | 'ENTREPRENEUR' | 'OUTSTAFF' | 'INTERN';
...
export type RequestType = 'VACATION' | 'TIME_OFF' | 'OVERTIME' | 'SHIFT_SWAP' | 'TIMESHEET_FIX' | 'TRIP' | 'PERIOD_CLOSE' | 'WORK_ACT';
...
export type PayloadOf<T extends EventType> = T extends keyof EventPayloadMap ? EventPayloadMap[T] : never;
